...
public abstract class BinaryParser implements BlockReaderAdapter {
	...
	/**
	 * Parse a list of Relation protocol buffers and send the resulting
	 * relations to a sink.
	 */
	...
	/**
	 * Parse a list of Node protocol buffers and send the resulting nodes to a
	 * sink.
	 */
	protected abstract void parseNodes(List<Osmformat.Node> nodes);

	/**
	 * Parse a list of Way protocol buffers and send the resulting ways to a
	 * sink.
	 */
